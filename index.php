				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="logo-nav">
								<a href="index.html">
									<img src="images/logo3.jpg" alt="Company logo" />
								</a>
							</div>
                            <!--End Logo -->
                ...
                <ul class="slides scroll">
                    <li class="first">
                        <div class="slider-text-wrapper">  
                            <div class="container">
                                <div class="big">Koncord Fidrak Construction </div>          
                                <div class="small">A firm that specializes in building construction works, sales, and supply of building materials.</div>
                                <a href="#projects" class="middle btn btn-white">VIEW PROJECTS</a>
                            </div>       
                        </div>
  ...
  <section  id="about" class="section">
       <div class="container">
           <div class="section-header">
              <h2>About Us</h2>
              <p>We are a firm that specializes in Building Construction Works, Sales, Supply and Distribution of Building Materials, Block Industry, Sales, Supply and Distribution of General goods, Manufacturer's representatives, manufacturing, general merchandise/ Trading general contracts.</p>
           </div>
           <div class="row">
              ...
              <div class="col-md-4">
                  <div class="features-icon-box">
                      ...
                      <div class="features-info">
                         ...
                         <p>We are not just delivering quality and sustainable designs done through collaborative efforts of our clients.</p>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="features-icon-box">
                      ...
                      <div class="features-info">
                         ...
                         <p>To be viewed as a respected architectural firm that provides high quality services to our clients with transparency and integrity.</p>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="features-icon-box">
                     ...
                     <i class="fa fa-life-saver"></i>
                      ...
                      <div class="features-info">
                         ...
                         <p>Transparency, Quality, Passion, Teamwork, Client Satisfaction.</p>
                      </div>
                  </div>
              </div>
  ...
  <!--End Section-->
   ...
   <section id="projects" class="section">
                  ...
                  <div class="title-box text-center">
					...
					<div class=" col-md-12 text-center">
						...
						<ul class="filtering">
							...
							<li class="filter" data-filter="fashion"></li>
							<li class="filter" data-filter="event"></li>
							<li class="filter" data-filter="wedding"></li>
							<li class="filter" data-filter="corporate"></li>
						</ul>
					</div>
				...
				<div class="work-main">
					...
					<ul class="work-grid">
						<!-- Work Item -->
						<li class="work-item thumnail-img mix corporate all">
						...
						<!-- Work Item -->
						<li class="work-item thumnail-img mix all">
							<div class="work-image">
                      ...
                      <div class="item">
                          ...
                          <div class="socials">
                              <ul>
                                ...
                                <li><a class="envelope" href="Concord8381@yahoo.com"><i class="fa fa-envelope"></i></a></li>
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                   <div class="services-box">
                       ...
                       <div class="services-desc">
                          <!-- <h4>Development</h4> -->
                          <p>Houses and Apartments for sale. </p>
                       </div>
                   </div>
               </div>
                <!--End services Item-->
               ...
               <div class="col-md-3">
                   <div class="services-box">
                       ...
                       <div class="services-desc">
                          <!-- <h4>Web Design</h4> -->
                          <p>Houses and Apartments for rent. </p>
                       </div>
                   </div>
               </div>
               <!--End services Item-->
              ...
              <!--End services Item-->
               ...
               <div class="col-md-3">
                <div class="services-box">
                    ...
                    <div class="services-desc">
                       <!-- <h4>HTML Basic</h4> -->
                       <p>Event Centres, Venues and Workstations. </p>
                    </div>
                </div>
            </div>
            <!--End services Item-->
               ...
               <div class="col-md-3">
                <div class="services-box">
                    ...
                    <div class="services-desc">
                       <!-- <h4>HTML Basic</h4> -->
                       <p>Building Construction and Maintenance. </p>
                    </div>
                </div>
            </div>
            <!--End services Item-->
           ...
           <div class="row">
               ...
               <div class="col-md-8 col-md-offset-2 contact-form">
                    ...
                    <div class="contact-info text-center">
                       <p>123 4567 890</p>
                       <p>94, Oyemekun Road, Akure, Ondo State</p>
                       <p>constructionfidrak@gmail.com</p>
                    </div>
                     
                     <form method="POST" action="php/mysqlinsertdata.php">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" id="message" name="message" rows="7" placeholder="Your Message"></textarea>
                            </div>
